...
print(f"total_snowfall: {total_snowfall}")

# TODO: how much total precipitation is in the entire dataset?
total_precip = reduce(lambda acc, elem: acc + (elem['prcp'] + elem['snow']), weatherdata, 0)
print(f"total_precip: {total_precip}")
